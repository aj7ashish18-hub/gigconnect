...
A full-stack gigconnect job marketplace where clients can post jobs and gigconnects can bid on them.Built with React (frontend), PHP (backend), and MySQL (database). Deployed on Render and Azure.

## Features

- Secure user authentication for clients and gigconnects
- Role-based dashboards
- JWT-like Token Authentication with Bearer Token support
- Clients can post, edit, and delete job listings
- gigconnects can view jobs and submit bids
